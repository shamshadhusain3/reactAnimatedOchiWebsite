  ...
  return (
    <div id='insights' className='h-screen w-full font-["Founders_Grotesk_X-Condensed"] flex gap-5 p-20'>
       ...
       <div className="headings">
            ...
            <h1 className="text-[5vw] uppercase -mt-12 tracking-tight font-semibold">openning</h1>
       ...
       <div className="headings">
            ...
            <h1 className="text-[5vw] uppercase -mt-3 tracking-tight font-semibold">Presentations</h1>
            <div className="links mt-20">
                {links.map((item,index)=>(
                    <a href="#" className='text-xl font-["Neue_Montreal"] block '>{item}</a>
                ))}
            </div>
